...
import (
	...
	"github.com/danielpickens/MobiusHPC/compute/image"
	"github.com/danielpickens/MobiusHPC/compute/slurm"
	kubecontainer "github.com/danielpickens/MobiusHPC/pkg/container"
	"github.com/danielpickens/MobiusHPC/pkg/hostutil"
...
func (h *podHandler) buildContainer(container *corev1.Container, containerStatus *corev1.ContainerStatus) (Container, error) {
	...
	img, err := image.Pull(compute.MobiusHPC.ImageDir(), image.Docker, container.Image)
	if err != nil {
...
func SyncContainerStatuses(pod *corev1.Pod) {
	...
	podDir := compute.MobiusHPC.Pod(podKey)
